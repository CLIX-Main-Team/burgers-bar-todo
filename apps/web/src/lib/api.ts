...
export const projectsApi = {
  ...
  // writes nothing. Chain owner only, and an empty `steps` is the ordinary answer while a 503 is a
  // model outage worth retrying. The route still lives under /tasks from its first home.
