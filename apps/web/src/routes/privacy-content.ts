    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Our AI provider, OpenRouter, which passes an assistant question and the relevant excerpts of company documents and app data to the language model that answers it. When the company material does not hold the answer, the model may run a web search through the same provider; the search engine receives a short query the model writes, not your question or any company document. The text of your question leaves our servers for this purpose.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'ספק הבינה המלאכותית שלנו, OpenRouter, שמעביר את שאלתך ואת הקטעים הרלוונטיים ממסמכי החברה ומנתוני האפליקציה אל מודל השפה שמנסח את התשובה. כשאין תשובה בחומר של החברה, המודל עשוי להריץ חיפוש באינטרנט דרך אותו ספק; מנוע החיפוש מקבל שאילתה קצרה שהמודל מנסח, לא את שאלתך ולא מסמך של החברה. לצורך זה נוסח השאלה שלך יוצא מהשרתים שלנו.',
