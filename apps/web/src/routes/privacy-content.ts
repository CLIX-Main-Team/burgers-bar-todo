    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'To answer your questions from the company’s own documents and app data first, and from a web search when those do not hold the answer.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Our AI provider, OpenRouter, which passes an assistant question and the relevant excerpts of company documents and app data to the language model that answers it. When the company material does not hold the answer, the model may run a web search through the same provider, and the search engine receives a short query written by the model. We do not send your question or a company document to the search engine ourselves, and once the assistant has read a colleague list or a WhatsApp summary it runs no further web search for that answer. The text of your question leaves our servers for this purpose.',
          'Green API, the WhatsApp gateway that forwards the messages of the company WhatsApp groups our number belongs to, so the app can summarise each group day by day.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'כדי לענות על שאלותיך קודם מתוך המסמכים והנתונים של החברה עצמה, ומחיפוש באינטרנט כשאין בהם תשובה.',
      ...
      },
      {
        ...
        bullets: [
          ...
          'ספק הבינה המלאכותית שלנו, OpenRouter, שמעביר את שאלתך ואת הקטעים הרלוונטיים ממסמכי החברה ומנתוני האפליקציה אל מודל השפה שמנסח את התשובה. כשאין תשובה בחומר של החברה, המודל עשוי להריץ חיפוש באינטרנט דרך אותו ספק, ומנוע החיפוש מקבל שאילתה קצרה שהמודל מנסח. איננו שולחים למנוע החיפוש את שאלתך או מסמך של החברה, ואחרי שהעוזר קרא רשימת עובדים או סיכום ווטסאפ הוא אינו מריץ חיפוש נוסף באינטרנט עבור אותה תשובה. לצורך זה נוסח השאלה שלך יוצא מהשרתים שלנו.',
          'Green API, שער הווטסאפ שמעביר את ההודעות מקבוצות הווטסאפ של החברה שהמספר שלנו חבר בהן, כדי שהאפליקציה תוכל לסכם כל קבוצה יום אחר יום.',
