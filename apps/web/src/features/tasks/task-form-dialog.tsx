              ...
              <ul className="flex flex-col gap-1">
                {checklist.map((item, index) => (
                  ...
                  >
                    ...
                    />
                    {/* The <bdi> goes INSIDE the stretched box, never on it. Both dir="auto" and a
                        bare <bdi> turn the box itself right-to-left for Hebrew text, which put
                        478px of white between a step and its own checkbox. The line wraps rather than truncating. `truncate` clips at the box's END,
