...
export const messages = {
  en: {
    ...
    access: {
      heading: 'Access',
      subtitle:
        'What each role can see and do. Access follows the role — to change what someone can do, change their role.',
      capabilityColumn: 'Capability',
      youChip: 'You',
      rolePicker: 'Show access for role',
      // The tier words. A cell is a mark plus a word — the word carries the scope, which
      // is the fact this page exists to show.
      levelYes: 'Yes',
      levelNone: 'No access',
      ...
      levelAllDocs: 'All documents',
      levelInternalDocs: 'Internal and general',
      levelGeneralDocs: 'General only',
      levelAnyRole: 'Any role',
      levelEmployeesOnly: 'Employees, own branch',
      groupTasks: 'Tasks',
      capViewTasks: 'See the task board',
      capManageTasks: 'Create, edit and delete tasks',
      capTaskStatus: 'Update task status',
      groupProjects: 'Projects',
      capViewProjects: 'See projects',
      capManageProjects: 'Create and manage projects',
      groupKnowledge: 'Assistant & knowledge',
      capAssistant: 'Ask the assistant',
      capAssistantSources: 'Documents answers may draw on',
      capKnowledge: 'Browse and sync the knowledge library',
      groupPeople: 'People',
      capViewRoster: 'See the team roster',
      capInvite: 'Invite new people',
      capDeactivate: 'Deactivate accounts',
      groupChain: 'The chain',
      capBranches: 'Add and manage branches',
    },
  },
  he: {
    common: {
    ...
    access: {
      heading: 'הרשאות',
      subtitle:
        'מה כל תפקיד רואה ויכול לעשות. ההרשאות נגזרות מהתפקיד — כדי לשנות מה שמישהו יכול לעשות, משנים את התפקיד שלו.',
      ...
      levelAllDocs: 'כל המסמכים',
      levelInternalDocs: 'פנימיים וכלליים',
      levelGeneralDocs: 'כלליים בלבד',
      levelAnyRole: 'כל תפקיד',
      levelEmployeesOnly: 'עובדים, בסניף שלהם',
      groupTasks: 'משימות',
      capViewTasks: 'צפייה בלוח המשימות',
      capManageTasks: 'יצירה, עריכה ומחיקה של משימות',
      capTaskStatus: 'עדכון סטטוס משימה',
      groupProjects: 'פרויקטים',
      capViewProjects: 'צפייה בפרויקטים',
      capManageProjects: 'יצירה וניהול של פרויקטים',
      groupKnowledge: 'עוזר ומאגר ידע',
      capAssistant: 'שאלות לעוזר',
      capAssistantSources: 'מסמכים שהתשובות מסתמכות עליהם',
      capKnowledge: 'עיון וסנכרון של מאגר הידע',
      groupPeople: 'צוות',
      capViewRoster: 'צפייה ברשימת הצוות',
      capInvite: 'הזמנת אנשים חדשים',
      capDeactivate: 'השבתת חשבונות',
      groupChain: 'הרשת',
      capBranches: 'הוספה וניהול של סניפים',
    },
  },
} as const
