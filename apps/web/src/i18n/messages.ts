...
export const messages = {
  en: {
    ...
    projects: {
      ...
      phase: 'Current phase',
      phasePlaceholder: 'Rollout, pilot, sign-off…',
      ...
      deleteBody: 'The project goes. Its tasks stay on the board, no longer filed under it.',
      saveFailed: 'That did not save. Check the name and try again.',
      progressIsTasks:
        'Progress is counted from the tasks inside the project — there is nothing to set here.',
      // The detail screen.
      details: 'Project details',
      tasks: 'Tasks',
      doneOf: '{done}/{total} done',
      noTasks: 'Nothing in this project yet. Add the first task below.',
      addTask: 'Add task',
      addTaskPlaceholder: 'Add a task to this project',
      toggleTask: 'Mark "{title}" done',
      taskFailed: 'That did not save. Try again.',
      mine: 'Mine',
      // Display states.
  ...
  he: {
    ...
    projects: {
      ...
      phase: 'שלב נוכחי',
      phasePlaceholder: 'הרצה, פיילוט, אישור סופי…',
      editProject: 'עריכת פרויקט',
      edit: 'עריכה',
      saveProject: 'שמירת פרויקט',
      deleteProject: 'מחיקת פרויקט',
      deleteTitle: 'למחוק את {name}?',
      deleteBody: 'הפרויקט נמחק. המשימות שלו נשארות בלוח, בלי שיוך לפרויקט.',
      saveFailed: 'השמירה לא עברה. בדקו את השם ונסו שוב.',
      progressIsTasks: 'ההתקדמות נספרת מהמשימות שבפרויקט — אין כאן מה להגדיר.',
      details: 'פרטי הפרויקט',
      tasks: 'משימות',
      doneOf: '{done}/{total} הושלמו',
      noTasks: 'עדיין אין כאן כלום. הוסיפו את המשימה הראשונה למטה.',
      addTask: 'הוספת משימה',
      addTaskPlaceholder: 'הוספת משימה לפרויקט הזה',
      toggleTask: 'סימון "{title}" כהושלמה',
      taskFailed: 'השמירה לא עברה. נסו שוב.',
      mine: 'שלי',
