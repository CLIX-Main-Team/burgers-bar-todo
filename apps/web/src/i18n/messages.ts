...
export const messages = {
  en: {
    ...
    tasks: {
      ...
      emptyBodySubject: 'Create the first task in this subject.',
      ...
      // Departments and subjects (owner ask 2026-09-20): the shared board opens on a department,
      // shows its subjects as cards, and a task is filed under one subject.
      fieldSubject: 'Subject',
      subjectPlaceholder: 'Choose a subject',
      subjectsLoadFailed: 'Could not load subjects.',
      subjectsNone: 'No subjects yet. A super admin creates them on the board.',
      subjectRequired: 'Choose a subject for this task.',
      departmentsLoadFailed: 'Could not load departments.',
      noDepartment: 'You are not in a department yet',
      noDepartmentHint: 'An admin can place you in one from the Users page.',
      subjectsEmpty: 'No subjects in {department} yet',
      subjectsEmptyHint: 'Create the first subject to start filing tasks under it.',
      subjectsEmptyReadOnly: 'A super admin creates the subjects tasks are filed under.',
      ...
      // The subject page's head card (Tasks redesign 2026-09-22): the open figure's two parts
      // that ask for something today, and the done count beside the spike.
      subjectOverdue: '{count} overdue',
      subjectDueToday: '{count} due today',
      subjectDone: '{count} done',
      // The strip that picks which tasks the page shows: your own, or a department's.
      boardNav: 'Which tasks',
      ...
      subjectDescriptionPlaceholder: 'One line, optional',
      subjectCreate: 'Create subject',
      subjectSave: 'Save',
      subjectDuplicate: 'This department already has a subject with that name.',
      subjectSaveFailed: 'That did not save. Try again.',
      subjectDeleteTitle: 'Delete “{name}”?',
      subjectDeleteBody: 'The subject goes away. Tasks cannot be filed under it afterwards.',
      subjectDeleteInUse:
        '{count, plural, one {Move or finish its # task first.} other {Move or finish its # tasks first.}}',
      subjectDeleteFailed: 'That did not delete. Try again.',
      subjectDeleteConfirm: 'Delete subject',
      backToDepartment: 'Back to {department}',
      backToTasks: 'Back to tasks',
      subjectNotFound: 'This subject is not here',
      subjectNotFoundHint: 'It may have been deleted, or it belongs to another department.',
      checklist: 'Checklist',
    ...
    dashboard: {
      ...
      filterAnyDepartment: 'Any department',
      heroTitle: 'Open tasks',
      heroOverdue: '{count} overdue',
      heroDueToday: '{count} due today',
      heroCalm: 'Nothing late, nothing due today',
      openBoard: 'Open the board',
      overviewTitle: 'Overview',
      tileDueToday: 'Due today',
      tileDueTodayNote: '{count, plural, =0 {none started yet} other {# already started}}',
      tileInProgress: 'In progress',
      tileInProgressNote:
        '{count, plural, =0 {nothing started} one {at one location} other {at # locations}}',
      tileOverdue: 'Overdue',
      tileOverdueNote: '{days, plural, one {oldest is a day late} other {oldest is # days late}}',
      tileOverdueNone: 'nothing is late',
      tileDoneWeek: 'Done this week',
      tileDoneWeekUp: '{percent}% more than last week',
      tileDoneWeekDown: '{percent}% fewer than last week',
      tileDoneWeekSame: 'same as last week',
      tileDoneWeekNew: 'none last week',
      tileProjects: 'Projects running',
      tileProjectsLate: '{count, plural, one {one past its target} other {# past their target}}',
      tileProjectsOnTime: 'all on schedule',
      activityTitle: 'Team activity',
      activityNote: 'Tasks created vs completed',
      activityCreated: 'Created',
      activityCompleted: 'Completed',
      activityRange: 'Last {days} days',
      activityChart: 'Tasks created and completed per day, last {days} days',
      workloadTitle: 'Team workload',
      workloadNote: 'Open tasks per person, late work first',
      workloadSearch: 'Search people',
      workloadOverdue: 'Overdue',
      workloadEmpty: 'Nobody has open work right now.',
      workloadNoMatch: 'Nobody by that name has open work.',
      workloadMore: '{count, plural, one {One more person} other {# more people}} with open work',
      workloadRow: '{name}: {open} open, {overdue} overdue, {todo} to do, {inProgress} in progress',
      chainTitle: 'Across the chain',
      chainNote: 'Where the open work sits',
      chainBranches: 'Branches',
      chainDepartments: 'Departments',
      ringBranches: 'Branches',
      ringBehind: 'Behind',
      ringOnTrack: 'On track',
      ringClear: 'All clear',
      ringOpen: 'Open tasks',
      colBranch: 'Branch',
      ...
      colOpen: 'Open',
      colOverdue: 'Late',
      chainAll: 'All branches',
      chainEmpty: 'Nothing is open anywhere.',
      attentionTitle: 'Needs attention',
      attentionNote: 'The work to chase first',
      attentionOverdue: 'Overdue',
      attentionToday: 'Due today',
      attentionHigh: 'High priority',
      attentionEmptyOverdue: 'Nothing is late.',
      attentionEmptyToday: 'Nothing is due today.',
      attentionEmptyHigh: 'No high-priority work is open.',
      attentionMore: '{count, plural, one {One more on the board} other {# more on the board}}',
      daysLate: '{days, plural, one {a day late} other {# days late}}',
      projectsTitle: 'Projects running',
      projectsNote: 'Openings, rollouts and audits in flight',
    ...
    access: {
      ...
      capTasksSubjects: 'Create, rename and delete subjects',
      ...
      scopeDepartments: 'Departments they can see',
      scopeDepartmentsAll: 'All departments',
      scopeDepartmentsOwn: 'Their department',
  ...
  he: {
    ...
    tasks: {
      ...
      emptyBodySubject: 'צרו את המשימה הראשונה בנושא הזה.',
      ...
      subjectsLoadFailed: 'לא ניתן לטעון את הנושאים.',
      subjectsNone: 'אין נושאים עדיין. מנהל־על יוצר אותם בלוח.',
      subjectRequired: 'בחרו נושא למשימה זו.',
      departmentsLoadFailed: 'לא ניתן לטעון את המחלקות.',
      noDepartment: 'עדיין לא שויכתם למחלקה',
      noDepartmentHint: 'מנהל יכול לשייך אתכם למחלקה מעמוד המשתמשים.',
      subjectsEmpty: 'אין עדיין נושאים ב{department}',
      subjectsEmptyHint: 'צרו את הנושא הראשון כדי להתחיל לתייק תחתיו משימות.',
      subjectsEmptyReadOnly: 'מנהל־על יוצר את הנושאים שהמשימות מתויקות תחתם.',
      newSubject: 'נושא חדש',
      ...
      subjectOverdue: '{count} באיחור',
      subjectDueToday: '{count} להיום',
      subjectDone: '{count, plural, one {הושלמה אחת} other {# הושלמו}}',
      boardNav: 'אילו משימות',
      ...
      subjectDescription: 'תיאור',
      subjectDescriptionPlaceholder: 'שורה אחת, לא חובה',
      subjectCreate: 'יצירת נושא',
      subjectSave: 'שמירה',
      subjectDuplicate: 'במחלקה הזו כבר יש נושא בשם הזה.',
      subjectSaveFailed: 'זה לא נשמר. נסו שוב.',
      subjectDeleteTitle: 'למחוק את “{name}”?',
      subjectDeleteBody: 'הנושא ייעלם. לא ניתן יהיה לתייק תחתיו משימות.',
      subjectDeleteInUse:
        '{count, plural, one {קודם העבירו או סיימו את המשימה שבו.} other {קודם העבירו או סיימו את # המשימות שבו.}}',
      subjectDeleteFailed: 'זה לא נמחק. נסו שוב.',
      subjectDeleteConfirm: 'מחיקת הנושא',
      backToDepartment: 'חזרה אל {department}',
      backToTasks: 'חזרה למשימות',
      subjectNotFound: 'הנושא הזה לא כאן',
      subjectNotFoundHint: 'ייתכן שנמחק, או שהוא שייך למחלקה אחרת.',
      checklist: 'צ׳קליסט',
    ...
    dashboard: {
      ...
      facetDepartment: 'מחלקה',
      filterAnyDepartment: 'כל המחלקות',
      heroTitle: 'משימות פתוחות',
      heroOverdue: '{count} באיחור',
      heroDueToday: '{count} להיום',
      heroCalm: 'אין איחורים ואין משימות להיום',
      openBoard: 'ללוח המשימות',
      overviewTitle: 'סקירה',
      tileDueToday: 'לסיום היום',
      tileDueTodayNote:
        '{count, plural, =0 {עוד לא התחילו} one {אחת כבר בביצוע} other {# כבר בביצוע}}',
      tileInProgress: 'בביצוע',
      tileInProgressNote:
        '{count, plural, =0 {שום דבר לא התחיל} one {במיקום אחד} other {ב-# מיקומים}}',
      tileOverdue: 'באיחור',
      tileOverdueNote:
        '{days, plural, one {הוותיקה באיחור של יום} other {הוותיקה באיחור של # ימים}}',
      tileOverdueNone: 'אין איחורים',
      tileDoneWeek: 'הושלמו השבוע',
      tileDoneWeekUp: '{percent}% יותר משבוע שעבר',
      tileDoneWeekDown: '{percent}% פחות משבוע שעבר',
      tileDoneWeekSame: 'כמו בשבוע שעבר',
      tileDoneWeekNew: 'אף אחת בשבוע שעבר',
      tileProjects: 'פרויקטים פעילים',
      tileProjectsLate: '{count, plural, one {אחד עבר את היעד} other {# עברו את היעד}}',
      tileProjectsOnTime: 'כולם בלוח הזמנים',
      activityTitle: 'פעילות הצוות',
      activityNote: 'משימות שנפתחו מול משימות שהושלמו',
      activityCreated: 'נפתחו',
      activityCompleted: 'הושלמו',
      activityRange: '{days} הימים האחרונים',
      activityChart: 'משימות שנפתחו והושלמו בכל יום, {days} הימים האחרונים',
      workloadTitle: 'עומס הצוות',
      workloadNote: 'משימות פתוחות לכל אדם, קודם האיחורים',
      workloadSearch: 'חיפוש אנשים',
      workloadOverdue: 'באיחור',
      workloadEmpty: 'לאף אחד אין משימות פתוחות כרגע.',
      workloadNoMatch: 'אין אף אחד בשם הזה עם משימות פתוחות.',
      workloadMore: '{count, plural, one {עוד אדם אחד} other {עוד # אנשים}} עם משימות פתוחות',
      workloadRow: '{name}: {open} פתוחות, {overdue} באיחור, {todo} לביצוע, {inProgress} בביצוע',
      chainTitle: 'בכל הרשת',
      chainNote: 'איפה נמצאת העבודה הפתוחה',
      chainBranches: 'סניפים',
      chainDepartments: 'מחלקות',
      ringBranches: 'סניפים',
      ringBehind: 'באיחור',
      ringOnTrack: 'בזמן',
      ringClear: 'ללא משימות',
      ringOpen: 'משימות פתוחות',
      colBranch: 'סניף',
      colDepartment: 'מחלקה',
      colOpen: 'פתוחות',
      colOverdue: 'באיחור',
      chainAll: 'כל הסניפים',
      chainEmpty: 'אין משימות פתוחות בשום מקום.',
      attentionTitle: 'דורש טיפול',
      attentionNote: 'מה לרדוף אחריו קודם',
      attentionOverdue: 'באיחור',
      attentionToday: 'להיום',
      attentionHigh: 'עדיפות גבוהה',
      attentionEmptyOverdue: 'שום דבר לא באיחור.',
      attentionEmptyToday: 'אין משימות להיום.',
      attentionEmptyHigh: 'אין משימות פתוחות בעדיפות גבוהה.',
      attentionMore: '{count, plural, one {עוד אחת בלוח} other {עוד # בלוח}}',
      daysLate: '{days, plural, one {יום באיחור} other {# ימים באיחור}}',
      projectsTitle: 'פרויקטים פעילים',
      projectsNote: 'פתיחות, השקות וביקורות בתהליך',
    ...
    access: {
      ...
      capTasksSubjects: 'יצירה, שינוי שם ומחיקה של נושאים',
      ...
      scopeDepartments: 'המחלקות שהם רואים',
      scopeDepartmentsAll: 'כל המחלקות',
      scopeDepartmentsOwn: 'המחלקה שלהם',
