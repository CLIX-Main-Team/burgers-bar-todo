...
export const taskSubjects = pgTable(
  'task_subjects',
  {
    ...
    // The branch this subject belongs to, or null for a subject of the whole chain (0052). A
...
export const whatsappDigests = pgTable(
  'whatsapp_digests',
  {
    ...
    // Which clock produced this one (0041). 'scheduled' is the 08:00 job; 'manual' is somebody
...
// One row per on-demand summary asked for in WhatsApp with the keyword סיכום (0041), and the only
