...
export interface AccountService {
  ...
  // Place a person in a department, or unplace them with null (2026-09-20), within scope: the
  // same AccountActionScope deactivate carries, passed straight through to the guarded write.
  // Sessions are left alone for the same reason assign leaves them. Returns the updated user,
  // or undefined when nothing matched (unknown id, out of scope, unknown department).
  updateDepartment(
    userId: string,
