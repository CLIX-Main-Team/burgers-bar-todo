...
foundation (#101) carved out (design-system map #65). Not security-sensitive. Establishes a
...
and #101 pushed the brand mark, wordmark, PWA icon, nav and assistant iconography, and
...
what #101 deferred is not design at all — it is mechanical composition of assets we already hold.
...
#65, sequenced right after #101; #101's out-of-scope bullet is narrowed to point there in the same
...
Holding the whole mark/wordmark/PWA-icon as a human visual-design pass — the way #101 originally
...
#101's out-of-scope bullet is narrowed in the same change: identity assets route to #103, nav
